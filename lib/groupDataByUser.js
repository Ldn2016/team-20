...
//gets history of a user from csv
...
function sortByTimeStamps(dataGroupedByUser){
...
function buildUserPaths(dataGroupedByUser){
  userPaths = {}
...
console.log(buildUserPaths(dataGroupedByUser))
// sortByTimeStamps(dataGroupedByUser)
