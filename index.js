...
this.server = http.createServer(function(req, res) {
  if (req.url === '/') {
    ...
    res.write(JSON.stringify({ nodes: [
          ...
          { data: { id: '1' , link: "http://demo.learningequality.org/learn/khan/math/early-math/cc-early-math-counting-topic/cc-early-math-counting/counting-with-small-numbers/", completed: false, unlocked: false } },
          { data: { id: '2' , link: "https://github.com", completed: false, unlocked: false } },
          { data: { id: '3' , link: "string0", completed: false, unlocked: false } },
          { data: { id: '4' , link: "string0", completed: false, unlocked: false } },
          { data: { id: '5' , link: "string0", completed: false, unlocked: false } },
          { data: { id: '6' , link: "string0", completed: false, unlocked: false } },
          { data: { id: '7' , link: "string0", completed: false, unlocked: false } }
        ],
        edges: [
